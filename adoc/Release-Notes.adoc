...
[source,bash]
----
helm install --name scf-cf --namespace scf suse/cf -f <values.yaml> --set config.HA=true \ 
...
[source,bash]
----
helm upgrade scf-uaa --namespace uaa suse/uaa --reuse-values --set config.HA=false \ 
--set sizing.uaa.count=2 --set sizing.mysql.count=1
helm upgrade scf-cf --namespace scf suse/cf --reuse-values --set config.HA=false \ 
...
[source,bash]
----
helm upgrade scf-uaa --namespace uaa suse/uaa  -f <values.yaml> --set config.HA=true \ 
--set config.HA_strict=false --set sizing.mysql.count=1
helm upgrade scf-cf --namespace scf suse/cf -f <values.yaml> --set config.HA=true \ 
--set config.HA_strict=false --set sizing.mysql.count=1 --set "secrets.UAA_CA_CERT=${CA_CERT}"
----
+
