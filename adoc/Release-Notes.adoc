...
* Eirini updated to 0.0.15
* PXC (Percona XtraDB Cluster) replaces cf-mysql for database management -- PLEASE READ IMPORTANT SECTION
* Added `config.HA_strict` flag to allow role size overrides on top of config.HA
