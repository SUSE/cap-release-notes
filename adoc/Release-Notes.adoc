...
========== Upgrade 1.4.1, HA but scale mysql to 1 ==========
UAA:
...
========== Upgrade to 1.5RC, HA but mysql at 1 ==========
UAA:
helm upgrade scf-uaa --namespace uaa <chart-path>  -f <rc-values.yaml> --set config.HA=true --set config.HA_strict=false --set sizing.mysql.count=1 --set sizing.uaa.count=2

SCF:
helm upgrade scf-cf --namespace scf <chart-path>  -f <rc-values.yaml> --set config.HA=true --set config.HA_strict=false --set sizing.mysql.count=1 --set "secrets.UAA_CA_CERT=${CA_CERT}"

========== Upgrade 1.5RC, full HA ==========

UAA:
helm upgrade scf-uaa --namespace uaa <chart-path> -f <rc-values.yaml> --set config.HA_strict=true --set config.HA=true

SCF:
helm upgrade scf-cf --namespace scf <chart-path> -f <rc-values.yaml> --set config.HA_strict=true --set config.HA=true --set "secrets.UAA_CA_CERT=${CA_CERT}"
