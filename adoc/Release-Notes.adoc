...
** Branding updated from "SUSE Stratos UI"
** Improved the Kubernetes Dashboard integration tied to configuration and reliability
...
** Support for SSH to application instances in Eirini
